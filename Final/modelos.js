...
Choferes.init({//estructura de tabla
...
Vehiculos.init({//estructura de tabla
    id_vehiculo: {type: DataTypes.INTEGER, allowNull: false, primaryKey: true},//aca agregamos que esta es primaryKey  
